...
public class DevicesSetProvider {
    public static String CONTENT_ITEM_TYPE;
    public static String CONTENT_TYPE;
    public static String DEVICE_AUTHORITY;

    public static final class DevicesSetColumns implements BaseColumns {
        ...
        public static final String TABLE_NAME = "devicesset";

        static {
            CONTENT_URI = Uri.parse("content://" + DevicesSetProvider.DEVICE_AUTHORITY + "/devicesset");
        }
    }
